...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double X_MULTIPLIER = 0.996074616955; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 0.999875286519; // Multiplier in the Y direction

    public static double LATERAL_DISTANCE = 12.6875; //11.46111; // 12.6875; // in; distance between the left and right wheels
